...
<body>
    ...
    <h1>Medications Registration</h1>
    <form action="med_input.php" method="post">
        ...
        <button onclick="location.href='display_medi.php'"><i class="fas fa-file-invoice-dollar"></i> View Labtest</button>
